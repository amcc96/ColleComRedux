...
public class trackerList extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_tracker_list, menu);
        return true;
    }
...
//        Boolean stock = productStock;
        /*TableLayout t1;

        TableLayout tl = (TableLayout) findViewById(R.id.tblTrackerList);
        ...
        tl.addView(tr_head, new TableLayout.LayoutParams(TableRow.LayoutParams.WRAP_CONTENT, TableRow.LayoutParams.MATCH_CONTENT)); //part 4*/
